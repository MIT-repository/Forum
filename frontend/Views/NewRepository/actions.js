...
export const postDiscussion = (userId, forumId, currentForum) => {
  return (dispatch, getState) => {
    ...
    if (title === null || title.length < 5) {
      ...
      return dispatch({
        type: POSTING_DISCUSSION_FAILURE,
        payload: 'Title should be at least 5 characters.',
      });
    }
    ...
    //   return dispatch({
    //     type: POSTING_DISCUSSION_FAILURE,
    //     payload: 'Please provide some files.',
    //   });
    // }
...
// /**
//  * update discussion files in redux state (controlled input)
//  * @param  {Array} value
//  * @return {action}
//  */
// export const updateDiscussionFile = (value) => {
//   return {
//     type: UPDATE_DISCUSSION_FILE,
//     payload: value,
//   };
// };